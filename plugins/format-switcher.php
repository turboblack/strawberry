...
Description:	Выбор разных форматов вывода новостей при публикации/редактировании.
Version: 		1.0
...
function fs_FormatSelectBox($hook){
	...
	$buffer = '<fieldset id="news_format"><legend>'.t('Формат').'</legend><select name="fs_format" id="cboFS_Format">'.fs_FormatDropDownOptions().'</select></fieldset>';
