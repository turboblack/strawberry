...
class WackoFormatterConfigDefault {
	...
	function PreLink($url, $text = ''){
		...
		if ($url == 'ljuser'){
			return '<a href="http://'.$text.'.livejournal.com/profile"><img height="17" src="'.$config['http_script_dir'].'/skins/images/user.gif" width="17" align="absmiddle" border="0" alt="[info]"></a><a href="http://'.$text.'.livejournal.com">'.$text.'</a>';
		} else {
